...
"""Verify that starting nyerium with -h works as expected."""
import subprocess

from test_framework.test_framework import NyeriumTestFramework
from test_framework.util import assert_equal

class HelpTest(NyeriumTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nyerium with -? for help text")
        ...
        self.log.info("Start nyerium with -version for version information")
