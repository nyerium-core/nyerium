...
In order to support loading of multiple wallets in nyerium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nyerium.cpp.
...
Changes to nyerium.cpp
----------------------
nyerium.cpp is the entry point into nyerium-qt, and as such, will require some minor modifications to provide hooks for
