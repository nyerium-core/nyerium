...
#ifndef Nyerium_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define Nyerium_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //Nyerium_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
