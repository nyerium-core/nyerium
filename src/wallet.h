...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 NYEX at the same time
...
enum ZerocoinSpendStatus {
    ...
    ZNYEX_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
...
public:
    ...
    */
    ...
    void setZNyexAutoBackups(bool fEnabled)
    {
