...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        blockchainHeader->setFont(font1);
        ...
        debugLogFileHeader->setFont(font1);
        ...
        label_repair_header->setFont(font1);
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Nyerium debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
