...
/**
 * Nyerium RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setznyexseed(const JSONRPCRequest& request);
extern UniValue getznyexseed(const JSONRPCRequest& request);
extern UniValue generatemintlist(const JSONRPCRequest& request);
extern UniValue searchdznyex(const JSONRPCRequest& request);
extern UniValue dznyexstate(const JSONRPCRequest& request);
