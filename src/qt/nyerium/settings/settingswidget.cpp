...
#include "qt/nyerium/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(NyeriumGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &NyeriumGUI::openFAQ);
