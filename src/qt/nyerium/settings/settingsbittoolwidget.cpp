...
#include "qt/nyerium/settings/settingsbittoolwidget.h"
#include "qt/nyerium/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(NyeriumGUI* _window, QWidget *parent) :
