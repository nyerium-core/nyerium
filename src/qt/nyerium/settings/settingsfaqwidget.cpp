...
#include "qt/nyerium/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/nyerium/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(NyeriumGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableNYEX,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableNYEX,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableNYEX,
    ...
    connect(ui->pushButton_UnspendableNYEX, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableNYEX);});
    ...
    if (parent)
        connect(parent, &NyeriumGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
