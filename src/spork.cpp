...
std::vector<CSporkDef> sporkDefs = {
    MAKE_SPORK_DEF(SPORK_2_SWIFTTX,                         1669852800ULL), // ON               // 1672444800
    MAKE_SPORK_DEF(SPORK_3_SWIFTTX_BLOCK_FILTERING,         1424217600ULL), // ON               // 1424217600
    MAKE_SPORK_DEF(SPORK_5_MAX_VALUE,                       1000),          // 1000 NYEX        // 1000
    MAKE_SPORK_DEF(SPORK_7_MASTERNODE_SCANNING,             978307200ULL),  // OFF              // DELETED
    MAKE_SPORK_DEF(SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT,  1601510400ULL), // OFF              // 1591401600
    MAKE_SPORK_DEF(SPORK_9_MASTERNODE_BUDGET_ENFORCEMENT,   1),             // OFF              // 1
    MAKE_SPORK_DEF(SPORK_10_MASTERNODE_PAY_UPDATED_NODES,   4070908800ULL), // OFF              // DELETED
    MAKE_SPORK_DEF(SPORK_13_ENABLE_SUPERBLOCKS,             1),             // 4070908800ULLOFF // 1
    MAKE_SPORK_DEF(SPORK_14_NEW_PROTOCOL_ENFORCEMENT,       1601510400ULL), // OFF              // 1591390800
    MAKE_SPORK_DEF(SPORK_15_NEW_PROTOCOL_ENFORCEMENT_2,     1601510400ULL), // OFF              // 1578182400
    MAKE_SPORK_DEF(SPORK_16_ZEROCOIN_MAINTENANCE_MODE,      4070908800ULL), // OFF              // 4070908800
    MAKE_SPORK_DEF(SPORK_17_PROPOSAL_VETO,                  1),             // OFF              // DELETED
    MAKE_SPORK_DEF(SPORK_17_COLDSTAKING_ENFORCEMENT,        1601510400ULL), // OFF              // 1578346098
    MAKE_SPORK_DEF(SPORK_18_ZEROCOIN_PUBLICSPEND_V4,        1601510400ULL), // OFF              // 1578346098
};
...
// Nyerium: on startup load spork values from previous session if they exist in the sporkDB
