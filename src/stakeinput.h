...
#ifndef Nyerium_STAKEINPUT_H
#define Nyerium_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZNYEX() const = 0;
    virtual CDataStream GetUniqueness() const = 0;
    virtual bool ContextCheck(int nHeight, uint32_t nTime) = 0;
};


class CNyexStake : public CStakeInput
{
private:
...
public:
    ...
    bool IsZNYEX() const override { return false; }
    bool ContextCheck(int nHeight, uint32_t nTime) override;
};


#endif //Nyerium_STAKEINPUT_H
