...
//
// The Masternode Class. It contains the input of the 25000 NYEX, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 25000 NYEX - checking if valid masternode)
