...
bool GetOldModifier(const CBlockIndex* pindexFrom, uint64_t& nStakeModifier)
{
    ...
    do {
        ...
        //LogPrintf("stakemodifier.cpp GetOldModifier do ==========================>: nStakeModifier: %s\n", std::to_string(nStakeModifier).c_str()); 
    ...
    //LogPrintf("stakemodifier.cpp GetOldModifier END do ==========================>: nStakeModifier: %s\n", std::to_string(nStakeModifier).c_str()); 
    return true;
}
...
bool GetOldStakeModifier(CStakeInput* stake, uint64_t& nStakeModifier)
{
    ...
    if (stake->IsZNYEX()) {
        ...
        while (pindexFrom && pindexFrom->nHeight + 1 <= nHeightStop) {
            if (pindexFrom->GetBlockTime() - nTimeBlockFrom > 60 * 60) {
                ...
                //LogPrintf("stakemodifier.cpp GetOldStakeModifier WHILE ==========================>: nStakeModifier: %s\n", std::to_string(nStakeModifier).c_str()); 
                return true;
            }
    ...
    //LogPrintf("stakemodifier.cpp GetOldStakeModifier END if stake->IsZNYEX() ==========================>: nStakeModifier: %s\n", std::to_string(nStakeModifier).c_str()); 
