...
#ifndef Nyerium_ZNYEXWALLET_H
#define Nyerium_ZNYEXWALLET_H
...
public:
    ...
    void GenerateDeterministicZNYEX(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZNYEX(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
