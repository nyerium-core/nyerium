...
#include "qt/nyerium/settings/settingsexportcsv.h"
#include "qt/nyerium/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(NyeriumGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("Nyerium_tx_csv_export(*.csv)") : tr("Nyerium_addresses_csv_export(*.csv)"),
                                        nullptr);
