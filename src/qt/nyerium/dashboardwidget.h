...
#include "config/nyerium-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalNyex = 0;
    qint64 totalZnyex = 0;
    QList<qreal> valuesNyex;
    QList<qreal> valueszNyex;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(NyeriumGUI* _window);
    ~DashboardWidget();
