...
#include "qt/nyerium/settings/settingsdisplayoptionswidget.h"
#include "qt/nyerium/settings/forms/ui_settingsdisplayoptionswidget.h"
#include <QListView>
#include <QSettings>
#include <QDir>
#include "guiutil.h"
...
SettingsDisplayOptionsWidget::SettingsDisplayOptionsWidget(NyeriumGUI* _window, QWidget *parent) :
