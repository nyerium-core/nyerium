...
#include "qt/nyerium/forms/ui_masternodewizarddialog.h"

#include "activemasternode.h"
#include "optionsmodel.h"
#include "pairresult.h"
#include "qt/nyerium/mnmodel.h"
    ...
    walletModel(model)
{
    ...
    if (walletModel->isRegTestNetwork()) {
        ui->lineEditPort->setText("55158");
    } else if (walletModel->isTestNetwork()) {
        ui->lineEditPort->setText("55150");
    } else {
        ui->lineEditPort->setText("57418");
    }
