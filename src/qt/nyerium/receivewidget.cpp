...
#include "qt/nyerium/forms/ui_receivewidget.h"
#include "qt/nyerium/requestdialog.h"
#include "qt/nyerium/addnewcontactdialog.h"
#include "qt/nyerium/qtutils.h"
#include "qt/nyerium/myaddressrow.h"
#include "qt/nyerium/furlistrow.h"
#include "qt/nyerium/addressholder.h"
...
ReceiveWidget::ReceiveWidget(NyeriumGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    setCssProperty(ui->pushButtonLabel, "btn-secondary-label");

    ui->pushButtonNewAddress->setLayoutDirection(Qt::RightToLeft);
    setCssProperty(ui->pushButtonNewAddress, "btn-secondary-new-address");

    ui->pushButtonCopy->setLayoutDirection(Qt::RightToLeft);
    setCssProperty(ui->pushButtonCopy, "btn-secondary-copy");
