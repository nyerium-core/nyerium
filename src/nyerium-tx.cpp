...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Nyerium Core nyerium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nyerium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nyerium transaction") + "\n" +
                               "  nyerium-tx [options] -create [commands]   " + _("Create hex-encoded nyerium transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nyerium transaction
