...
#ifndef Nyerium_ZNYEXTRACKER_H
#define Nyerium_ZNYEXTRACKER_H
...
public:
    CzNYEXTracker(CWallet* parent);
    ~CzNYEXTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzNYEXWallet* zNYEXWallet = NULL);
