...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        SendCoinsDialog->resize(880, 705);
        QFont font;
        font.setFamily(QStringLiteral("Ara Hamah 1982"));
        font.setPointSize(14);
        SendCoinsDialog->setFont(font);
        ...
        QFont font1;
        font1.setFamily(QStringLiteral("Ara Hamah 1982"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 NYEX"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 NYEX"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 860, 137));
        ...
        labelFeeMinimized->setFont(font4);
        ...
        labelMinFeeWarning->setFont(font4);
        ...
        labelSmartFeeNormal->setFont(font4);
        ...
        labelSmartFeeFast->setFont(font4);
        ...
        labelFeeEstimation->setFont(font4);
        ...
        clearButton->setIconSize(QSize(25, 25));
        ...
        checkzNYEX = new QCheckBox(SendCoinsDialog);
        checkzNYEX->setObjectName(QStringLiteral("checkzNYEX"));
        checkzNYEX->setEnabled(false);

        horizontalLayout_2->addWidget(checkzNYEX);
        ...
        labelBalance->setText(QStringLiteral("123.456 NYEX"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelBlockSize->setText(QApplication::translate("SendCoinsDialog", "0 NYEX", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        radioCustomPerKilobyte->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uNYEs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uNYEs in fee,<br />while \"at least\" pays 1000 uNYEs. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomPerKilobyte->setText(QApplication::translate("SendCoinsDialog", "per kilobyte", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        radioCustomAtLeast->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uNYEs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uNYEs in fee,<br />while \"total at least\" pays 1000 uNYEs. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomAtLeast->setText(QApplication::translate("SendCoinsDialog", "total at least", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for Nyerium transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for Nyerium transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        checkzNYEX->setText(QApplication::translate("SendCoinsDialog", "Anonymized NYEX", Q_NULLPTR));
