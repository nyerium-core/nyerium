...
public:
    ...
    void setupUi(QDialog *Bip38ToolDialog)
    {
        ...
        Bip38ToolDialog->resize(700, 330);
        QFont font;
        font.setFamily(QStringLiteral("Ara Hamah 1982"));
        font.setPointSize(14);
        Bip38ToolDialog->setFont(font);
        ...
        encryptedKeyOut_ENC->setFont(font1);
        ...
        encryptedKeyIn_DEC->setFont(font);
        ...
        decryptKeyButton_DEC->setFont(font);
        QIcon icon5;
        ...
        QFont font3;
        font3.setFamily(QStringLiteral("Ara Hamah 1982"));
        font3.setPointSize(14);
        font3.setBold(true);
        font3.setWeight(75);
        statusLabel_DEC->setFont(font3);
        ...
        decryptedKeyOut_DEC->setFont(font);
        ...
        importAddressButton_DEC->setFont(font);
    ...
    void retranslateUi(QDialog *Bip38ToolDialog)
    {
        ...
        infoLabel_ENC->setText(QApplication::translate("Bip38ToolDialog", "Enter a Nyerium Address that you would like to encrypt using BIP 38. Enter a passphrase in the middle box. Press encrypt to compute the encrypted private key.", Q_NULLPTR));
        label_5->setText(QApplication::translate("Bip38ToolDialog", "Address:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        addressIn_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "The Nyerium address to sign the message with", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        encryptKeyButton_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "Sign the message to prove you own this Nyerium address", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        encryptedKeyIn_DEC->setToolTip(QApplication::translate("Bip38ToolDialog", "The Nyerium address the message was signed with", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("Bip38ToolDialog", "Passphrase: ", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        decryptKeyButton_DEC->setToolTip(QApplication::translate("Bip38ToolDialog", "Verify the message to ensure it was signed with the specified Nyerium address", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
