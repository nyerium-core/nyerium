...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Nyerium server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Nyerium features */
        {"nyerium", "masternode", &masternode, true, true, false},
        {"nyerium", "listmasternodes", &listmasternodes, true, true, false},
        {"nyerium", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nyerium", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nyerium", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nyerium", "masternodedebug", &masternodedebug, true, true, false},
        {"nyerium", "startmasternode", &startmasternode, true, true, false},
        {"nyerium", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nyerium", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nyerium", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nyerium", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nyerium", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nyerium", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nyerium", "mnbudget", &mnbudget, true, true, false},
        {"nyerium", "preparebudget", &preparebudget, true, true, false},
        {"nyerium", "submitbudget", &submitbudget, true, true, false},
        {"nyerium", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nyerium", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nyerium", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nyerium", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nyerium", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nyerium", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nyerium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nyerium", "checkbudgets", &checkbudgets, true, true, false},
        {"nyerium", "mnsync", &mnsync, true, true, false},
        {"nyerium", "spork", &spork, true, true, false},
        {"nyerium", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"nyerium", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use nyeriumd, or the -server option to nyerium-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> nyerium-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:24875/\n";
}
