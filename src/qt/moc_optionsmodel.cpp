...
QT_MOC_LITERAL(6, 86, 29), // "anonymizeNyeriumAmountChanged"
QT_MOC_LITERAL(7, 116, 26) // "coinControlFeaturesChanged"

    },
    "OptionsModel\0displayUnitChanged\0\0unit\0"
    "zeromintPercentageChanged\0"
    "preferredDenomChanged\0"
    "anonymizeNyeriumAmountChanged\0"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->anonymizeNyeriumAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::anonymizeNyeriumAmountChanged)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 3
void OptionsModel::anonymizeNyeriumAmountChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
