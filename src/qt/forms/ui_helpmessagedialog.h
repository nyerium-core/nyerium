...
public:
    ...
    void setupUi(QDialog *HelpMessageDialog)
    {
        ...
        HelpMessageDialog->resize(630, 400);
        HelpMessageDialog->setMinimumSize(QSize(630, 400));
        QFont font;
        font.setPointSize(10);
        HelpMessageDialog->setFont(font);
        HelpMessageDialog->setWindowTitle(QStringLiteral("Nyerium Core - Command-line options"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 521, 143));
