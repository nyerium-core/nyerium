...
std::vector<CSporkDef> sporkDefs = {
    MAKE_SPORK_DEF(SPORK_2_SWIFTTX,                         978307200ULL),             // ON
    MAKE_SPORK_DEF(SPORK_3_SWIFTTX_BLOCK_FILTERING,         1424217600ULL),             // ON
    MAKE_SPORK_DEF(SPORK_5_MAX_VALUE,                       1000),          // 1000 NYEX
    MAKE_SPORK_DEF(SPORK_7_MASTERNODE_SCANNING,             978307200ULL), // OFF
    ...
    MAKE_SPORK_DEF(SPORK_17_PROPOSAL_VETO,          1), // OFF
    MAKE_SPORK_DEF(SPORK_17_COLDSTAKING_ENFORCEMENT,        1424217600ULL), // OFF
