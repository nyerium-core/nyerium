...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Nyerium features */
        {"nyerium", "listmasternodes", &listmasternodes, true },
        {"nyerium", "getmasternodecount", &getmasternodecount, true },
        {"nyerium", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"nyerium", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"nyerium", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"nyerium", "masternodecurrent", &masternodecurrent, true },
        {"nyerium", "startmasternode", &startmasternode, true },
        {"nyerium", "createmasternodekey", &createmasternodekey, true },
        {"nyerium", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"nyerium", "listmasternodeconf", &listmasternodeconf, true },
        {"nyerium", "getmasternodestatus", &getmasternodestatus, true },
        {"nyerium", "getmasternodewinners", &getmasternodewinners, true },
        {"nyerium", "getmasternodescores", &getmasternodescores, true },
        {"nyerium", "preparebudget", &preparebudget, true },
        {"nyerium", "submitbudget", &submitbudget, true },
        {"nyerium", "mnbudgetvote", &mnbudgetvote, true },
        {"nyerium", "getbudgetvotes", &getbudgetvotes, true },
        {"nyerium", "getnextsuperblock", &getnextsuperblock, true },
        {"nyerium", "getbudgetprojection", &getbudgetprojection, true },
        {"nyerium", "getbudgetinfo", &getbudgetinfo, true },
        {"nyerium", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"nyerium", "mnfinalbudget", &mnfinalbudget, true },
        {"nyerium", "checkbudgets", &checkbudgets, true },
        {"nyerium", "mnsync", &mnsync, true },
        {"nyerium", "spork", &spork, true },
        ...
        {"zerocoin", "getznyexseed", &getznyexseed, false },
        {"zerocoin", "setznyexseed", &setznyexseed, false },
        {"zerocoin", "generatemintlist", &generatemintlist, false },
        {"zerocoin", "searchdznyex", &searchdznyex, false },
        {"zerocoin", "dznyexstate", &dznyexstate, false },
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:55149/\n";
}
