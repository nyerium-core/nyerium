...
The script [extract-osx-sdk.sh](https://github.com/nyerium-core/nyerium/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
nyerium/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/nyerium-core/nyerium/blob/master/doc/README_osx.md) for troubleshooting tips.
