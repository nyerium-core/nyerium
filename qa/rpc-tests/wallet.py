...
#   c) node1 mines 32 blocks, so now node 0 has 60001nyex, node 1 has 4250nyex, node2 has none.
#   d) node0 sends 601 nyex to node2, in two transactions (301 nyex, then 300 nyex).
