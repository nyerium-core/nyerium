...
#include "qt/nyerium/settings/settingswalletrepairwidget.h"
#include "qt/nyerium/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/nyerium/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(NyeriumGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to NyeriumGUI::handleRestart()
