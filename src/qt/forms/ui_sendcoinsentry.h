...
public:
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        SendCoinsEntry->resize(729, 181);
        QFont font;
        font.setFamily(QStringLiteral("Ara Hamah 1982"));
        font.setPointSize(14);
        SendCoinsEntry->setFont(font);
        ...
        addressBookButton->setIconSize(QSize(30, 30));
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The Nyerium address to send the payment to", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the Nyerium: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the Nyerium network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
