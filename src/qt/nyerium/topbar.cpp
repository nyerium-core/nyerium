...
#include "qt/nyerium/topbar.h"
#include "qt/nyerium/forms/ui_topbar.h"
#include "qt/nyerium/lockunlock.h"
#include "qt/nyerium/qtutils.h"
#include "qt/nyerium/receivedialog.h"
#include "qt/nyerium/loadingdialog.h"
...
TopBar::TopBar(NyeriumGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopNyex}, "amount-small-topbar");
    setCssProperty({ui->labelAmountNyex}, "amount-topbar");
    setCssProperty({ui->labelPendingNyex, ui->labelImmatureNyex}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("Nyerium")
    updateDisplayUnit();
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // NYEX Total
    QString totalNyex = GUIUtil::formatBalance(balance, nDisplayUnit);

    // NYEX
    // Top
    ui->labelAmountTopNyex->setText(totalNyex);
    // Expanded
    ui->labelAmountNyex->setText(totalNyex);
    ui->labelPendingNyex->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureNyex->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
