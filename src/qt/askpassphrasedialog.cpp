...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            NyeriumGUI* window = static_cast<NyeriumGUI*>(parentWidget());
...
{
    NyeriumGUI* gui = static_cast<NyeriumGUI*>(parentWidget());
...
{
    hide();
    static_cast<NyeriumGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Nyerium will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your NYEXs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
