Contributing to Nyerium Core
============================

The Nyerium Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Nyerium Core project, and is not to be
confused with overall Nyerium Network Protocol consensus changes.

Whether a pull request is merged into Nyerium Core rests with the project merge
...
Patches that change Nyerium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Nyerium consensus, it must have been
...
The project leader is the release manager for each Nyerium Core release.
