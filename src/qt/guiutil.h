...
/** Utility functions used by the Nyerium Qt UI.
 */
namespace GUIUtil
{
...
// Render Nyerium addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZnyex = false);
...
// Parse "nyerium:" URI into recipient object, return true on successful parsing
