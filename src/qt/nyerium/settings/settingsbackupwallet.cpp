...
#include "qt/nyerium/settings/settingsbackupwallet.h"
#include "qt/nyerium/settings/forms/ui_settingsbackupwallet.h"
#include <QFile>
...
#include "qt/nyerium/qtutils.h"
SettingsBackupWallet::SettingsBackupWallet(NyeriumGUI* _window, QWidget *parent) :
