...
static const int DBI_OLD_SER_VERSION =   1000300; //4009900;
static const int DBI_SER_VERSION_NO_ZC = 1000400; //4009902;   // removes mapZerocoinSupply, nMoneySupply
...
/*        if (nSerVersion >= DBI_SER_VERSION_NO_ZC) {
            ...
            // } else {
                //uint256 nStakeModifierV2; //EK TEST 20200920 CHECK IF WORKS OR NOT
                //READWRITE(nStakeModifierV2); //EK TEST 20200920 CHECK IF WORKS OR NOT
...
public:
    ...
    inline void SerializationOp(Stream& s, Operation ser_action)
    {
        ...
        /*if (nSerVersion > DBI_OLD_SER_VERSION) {
            ...
            //if (!Params().GetConsensus().NetworkUpgradeActive(nHeight, Consensus::UPGRADE_V3_4)) {
                //READWRITE(nStakeModifier);
                READWRITE(vStakeModifier); // EK TODO 9/21
            //} else {
