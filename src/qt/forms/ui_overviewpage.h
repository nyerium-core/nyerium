...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        QFont font2;
        font2.setFamily(QStringLiteral("Ara Hamah 1982"));
        font2.setPointSize(12);
        font2.setBold(false);
        font2.setItalic(false);
        font2.setWeight(50);
        label_5->setFont(font2);
        label_5->setStyleSheet(QLatin1String("background-color: rgb(255, 170, 0);\n"
"color: rgb(255, 255, 255);"));
        ...
        labelWatchPending->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 NYEX"));
        ...
        labelUnconfirmed->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 NYEX"));
        ...
        labelWatchImmature->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 NYEX"));
        ...
        lineSpendableBalance->setFont(font1);
        lineSpendableBalance->setLineWidth(1);
        ...
        lineWatchBalance->setFont(font1);
        ...
        labelImmature->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 NYEX"));
        ...
        labelTotal->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 NYEX"));
        ...
        labelWatchTotal->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 NYEX"));
        ...
        labelBalance->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 NYEX"));
        ...
        labelWatchAvailable->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 NYEX"));
        ...
        frameObfuscation->setFont(font1);
        ...
        frame_3->setGeometry(QRect(0, 200, 531, 231));
        ...
        label_5z->setStyleSheet(QLatin1String("background-color: rgb(255, 170, 0);\n"
"color: rgb(255, 255, 255);"));
        label_5z->setTextFormat(Qt::AutoText);
        ...
        lineSpendableBalance_3->setFont(font1);
        ...
        lineWatchBalance_3->setFont(font1);
        ...
        labelzBalancez->setFont(font2);
        labelzBalancez->setCursor(QCursor(Qt::IBeamCursor));
        labelzBalancez->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 NYEX"));
        labelzBalancez->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
        ...
        labelTotalz->setFont(font2);
        labelTotalz->setCursor(QCursor(Qt::IBeamCursor));
        labelTotalz->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 NYEX"));
        labelTotalz->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
        ...
        labelBalanceTextz->setFont(font2);
        ...
        labelBalancez->setFont(font2);
        labelBalancez->setCursor(QCursor(Qt::IBeamCursor));
        labelBalancez->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 NYEX"));
        labelBalancez->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
        ...
        labelzBalanceTextz->setFont(font2);

        gridLayout_3->addWidget(labelzBalanceTextz, 4, 0, 1, 1);

        labelzNYEXPercent = new QLabel(frame_3);
        labelzNYEXPercent->setObjectName(QStringLiteral("labelzNYEXPercent"));
        labelzNYEXPercent->setFont(font2);
        labelzNYEXPercent->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_3->addWidget(labelzNYEXPercent, 4, 2, 1, 1);

        label100Percent = new QLabel(frame_3);
        label100Percent->setObjectName(QStringLiteral("label100Percent"));
        label100Percent->setFont(font2);
        ...
        labelLockedBalance->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
        ...
        labelUnLockedBalanceText->setFont(font2);
        ...
        labelUnLockedBalance->setFont(font2);
        labelUnLockedBalance->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);

        gridLayout_3->addWidget(labelUnLockedBalance, 3, 1, 1, 1);

        labelNYEPercent = new QLabel(frame_3);
        labelNYEPercent->setObjectName(QStringLiteral("labelNYEPercent"));
        labelNYEPercent->setFont(font2);
        labelNYEPercent->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_3->addWidget(labelNYEPercent, 3, 2, 1, 1);
        ...
        frame_4->setGeometry(QRect(0, 10, 531, 201));
        ...
        label_5z_3->setStyleSheet(QLatin1String("background-color: rgb(255, 170, 0);\n"
"color: rgb(255, 255, 255);"));
        ...
        labelzBalanceMatureText->setFont(font2);
        ...
        lineSpendableBalance_5->setFont(font1);
        ...
        labelzBalance->setFont(font2);
        labelzBalance->setCursor(QCursor(Qt::IBeamCursor));
        labelzBalance->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 zNYEX"));
        labelzBalance->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
        ...
        lineWatchBalance_5->setFont(font1);
        ...
        labelzBalanceText->setFont(font2);
        ...
        labelzBalanceMature->setFont(font2);
        labelzBalanceMature->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
        ...
        labelzBalanceUnconfirmedText->setFont(font2);
        ...
        labelzBalanceUnconfirmed->setFont(font2);
        labelzBalanceUnconfirmed->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
        ...
        labelzBalanceImmatureText->setFont(font2);
        ...
        labelzBalanceImmature->setFont(font2);
        labelzBalanceImmature->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
        ...
        listTransactions->setFont(font2);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        label_5->setText(QApplication::translate("OverviewPage", "NYEX Balances", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Nyerium network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label_5z->setText(QApplication::translate("OverviewPage", "Combined Balances", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ...
        labelBalanceTextz->setText(QApplication::translate("OverviewPage", "NYEX:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        labelzBalanceTextz->setText(QApplication::translate("OverviewPage", "zNYEX:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelzNYEXPercent->setToolTip(QApplication::translate("OverviewPage", "Current percentage of zNYEX.\n"
"If AutoMint is enabled this percentage will settle around the configured AutoMint percentage (default = 10%)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labelzNYEXPercent->setText(QApplication::translate("OverviewPage", "0 %", Q_NULLPTR));
        label100Percent->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelLockedBalance->setToolTip(QApplication::translate("OverviewPage", "Locked NYEX or Masternode collaterals. These are excluded from zNYEX minting.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labelLockedBalance->setText(QApplication::translate("OverviewPage", "0.000\342\200\211000\342\200\21100 NYEX", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelLockedBalanceText->setToolTip(QApplication::translate("OverviewPage", "Locked NYEX or Masternode collaterals. These are excluded from zNYEX minting.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labelLockedBalanceText->setText(QApplication::translate("OverviewPage", "Locked:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelUnLockedBalanceText->setToolTip(QApplication::translate("OverviewPage", "Unlocked NYEs. These can be used for zNYEX minting.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labelUnLockedBalanceText->setText(QApplication::translate("OverviewPage", "Unlocked:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelUnLockedBalance->setToolTip(QApplication::translate("OverviewPage", "Unlocked NYEs. These can be used for zNYEX minting.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labelUnLockedBalance->setText(QApplication::translate("OverviewPage", "0.000\342\200\211000\342\200\21100 NYEX", Q_NULLPTR));
        labelNYEPercent->setText(QApplication::translate("OverviewPage", "0 %", Q_NULLPTR));
        label_5z_3->setText(QApplication::translate("OverviewPage", "zNYEX Balance", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
"These zNYEX are spendable.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labelzBalanceMatureText->setText(QApplication::translate("OverviewPage", "Mature:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelzBalance->setToolTip(QApplication::translate("OverviewPage", "All available zNYEX, unconfirmed and immature zNYEX included.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        labelzBalanceText->setToolTip(QApplication::translate("OverviewPage", "All available zNYEX, unconfirmed and immature zNYEX included.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
"These zNYEX are spendable.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labelzBalanceMature->setText(QApplication::translate("OverviewPage", "0.000\342\200\211000\342\200\21100 zNYEX", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
"Immature: confirmed, but less than 1 mints of the same denomination after it was minted", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labelzBalanceUnconfirmed->setText(QApplication::translate("OverviewPage", "0.000\342\200\211000\342\200\21100 zNYEX", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
"Immature: confirmed, but less than 1 mints of the same denomination after it was minted", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labelzBalanceImmature->setText(QApplication::translate("OverviewPage", "0.000\342\200\211000\342\200\21100 zNYEX", Q_NULLPTR));
        label_4->setText(QApplication::translate("OverviewPage", "Recent transactions", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Nyerium network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
