/* src/config/nyerium-config.h.  Generated from nyerium-config.h.in by configure.  */
/* src/config/nyerium-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef NYEX_CONFIG_H

#define NYEX_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/nyerium-core/nyerium/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Nyerium Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Nyerium Core 1.0.4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "nyerium"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://nyerium.org/"
