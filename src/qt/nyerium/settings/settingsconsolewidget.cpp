...
#include "qt/nyerium/settings/settingsconsolewidget.h"
#include "qt/nyerium/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/nyerium/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(NyeriumGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Nyerium RPC console.") + "<br>" +
...
void SettingsConsoleWidget::changeTheme(bool isLightTheme, QString &theme)
{
    ...
    if (isLightTheme) {
        ui->messagesWidget->document()->setDefaultStyleSheet(
                ...
                "td.message { color: #e1e7e7;font-family: Courier, Courier New, Lucida Console, monospace; font-size: 12px; } " // Todo: Remove fixed font-size
