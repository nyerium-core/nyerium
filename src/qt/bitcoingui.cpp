                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Nyerium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nyerium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nyerium: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zNYEX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Nyerium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nyerium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nyerium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nyerium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nyerium addresses"));
    ...
    openAction->setStatusTip(tr("Open a Nyerium: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nyerium Core help message to get a list with possible Nyerium command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nyerium network", "", count));
}
