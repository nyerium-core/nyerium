...
#include "qt/nyerium/sendcustomfeedialog.h"
#include "qt/nyerium/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(NyeriumGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &NyeriumGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
