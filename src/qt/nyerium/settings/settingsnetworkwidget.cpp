...
#include "qt/nyerium/settings/settingsnetworkwidget.h"
#include "qt/nyerium/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/nyerium/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(NyeriumGUI* _window, QWidget *parent) :
