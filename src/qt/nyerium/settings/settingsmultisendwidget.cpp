...
#include "qt/nyerium/settings/settingsmultisendwidget.h"
#include "qt/nyerium/settings/forms/ui_settingsmultisendwidget.h"
#include "qt/nyerium/settings/settingsmultisenddialog.h"
...
public:
    ...
    QWidget* createHolder(int pos) override
    {
        if (!row) {
            ...
            lblDivisory->setStyleSheet(QStringLiteral("background-color:#BFBFBF;"));
    ...
    ui(new Ui::SettingsMultisendWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("MultiSend allows you to automatically send up to 100% of your stake or masternode reward to a list of other Nyerium addresses after it matures."));
