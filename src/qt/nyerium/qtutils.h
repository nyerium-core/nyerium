...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, NyeriumGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, NyeriumGUI* gui, double posX = 3);
