...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Nyerium address (e.g. %1)").arg("NqpjKV7LyS6SiZGh9ve3CReezksCqqpz7b"));
#endif
...
void openConfigfile()
{
    ...
    /* Open nyerium.conf with the associated application */
