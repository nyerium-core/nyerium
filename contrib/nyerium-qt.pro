...
RESOURCES += src/qt/nyerium.qrc src/qt/nyerium_locale.qrc

TRANSLATIONS += src/qt/locale/nyerium_bg.ts \
                src/qt/locale/nyerium_de.ts \
                src/qt/locale/nyerium_en.ts \
                src/qt/locale/nyerium_es.ts \
                src/qt/locale/nyerium_fi.ts \
                src/qt/locale/nyerium_fr.ts \
                src/qt/locale/nyerium_it.ts \
                src/qt/locale/nyerium_ja.ts \
                src/qt/locale/nyerium_pl.ts \
                src/qt/locale/nyerium_pt.ts \
                src/qt/locale/nyerium_ru.ts \
                src/qt/locale/nyerium_sk.ts \
                src/qt/locale/nyerium_sv.ts \
                src/qt/locale/nyerium_vi.ts \
                src/qt/locale/nyerium_zh_CN.ts \
                src/qt/locale/nyerium_zh_TW.ts
