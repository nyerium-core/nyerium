                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Nye from zNyex"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zNyex"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zNyex));
