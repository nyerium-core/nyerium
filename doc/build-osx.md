...
1. Clone the Nyerium Core source code:

        git clone https://github.com/nyerium-core/nyerium
        cd nyerium
...
Nyerium Core is now available at `./src/nyeriumd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/Nyerium"

    touch "/Users/${USER}/Library/Application Support/Nyerium/nyerium.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Nyerium/nyerium.conf"

The first time you run nyeriumd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/nyeriumd -daemon # Starts the nyerium daemon.
    ./src/nyerium-cli --help # Outputs a list of command-line options.
    ./src/nyerium-cli help # Outputs a list of RPC commands when the daemon is running.
