...
#include "qt/nyerium/settings/settingssignmessagewidgets.h"
#include "qt/nyerium/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(NyeriumGUI* _window, QWidget *parent) :
